...
import { HorizontalProductCard } from "deco-sites/fires/components/product/HorizontalProductCard.tsx";
...
export default function SectionHorizontalCard({
    ...
    return (
        <div
            class={`${maxWidth} flex flex-col container bg-primary text-center rounded p-5 mt-3 md:flex-row xl:max-w-6xl`}
